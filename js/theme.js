(function() {
    const buttonHTML = `
        <button id="theme-toggle" class="absolute top-4 right-4 z-50 p-2 rounded-full text-brand-text hover:bg-brand-surface transition-colors" aria-label="Toggle Theme">
