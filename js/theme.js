(function() {
    ...
    if (themeToggle) {
        themeToggle.addEventListener('click', function() {
            ...
            if (window.recolorConstellation) { window.recolorConstellation(); }
        });
    }
